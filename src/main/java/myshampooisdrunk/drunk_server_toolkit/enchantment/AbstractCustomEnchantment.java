...
public abstract class AbstractCustomEnchantment {
    ...
    protected AbstractCustomEnchantment(Identifier id,Rarity rarity, EnchantmentTarget target, EquipmentSlot[] slotTypes) {
        ...
        this.id = id;
        this.translationKey = CUSTOM_ENCHANTMENT_TRANSLATION_KEY + id.toTranslationKey();
    }
    ...
    public Text getName(int level) {
        MutableText mutableText = Text.translatable(this.getTranslationKey()).setStyle(Style.EMPTY.withItalic(false));
        if (this.isCursed()) {
