...
//        dispatcher.register(
//                (LiteralArgumentBuilder)((LiteralArgumentBuilder) CommandManager.literal("give_book")
...
//                                        .executes(context -> GiveBookCommand.execute(
...
//                ItemStack ret = Items.ENCHANTED_BOOK.getDefaultStack();
//                CustomEnchantmentHelper.addBookEnchant(ret,new CustomEnchantmentInstance(enchantment,level));
